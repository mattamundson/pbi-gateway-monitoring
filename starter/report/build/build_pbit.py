...
SCHEMA = {
 "gold_gateway_health": [("GatewayObjectId","string"),("last_heartbeat_utc","dateTime"),("heartbeat_age_minutes","int64"),
    ...
    ("network_util_pct","double"),("network_latency_p95_ms","double"),("spool_free_pct","double")],
 "gold_query_performance": [("QueryType","string"),("DataSource","string"),("query_count","int64"),("error_count","int64"),
    ...
    ("spool_writing_ms_avg","double"),("spooled_query_count","int64")],
 ...
 "silver_identity_attribution": [("attribution_kind","string"),("artifact_id","string"),("DataSource","string"),("confidence_level","string")],
